      ...
      <header className='sticky top-0 z-50 border-b border-white/10 bg-dark-main/90 backdrop-blur-sm'>
        <nav className='container flex items-center justify-between py-4'>
          ...
          <a
            ...
            download
            className='hidden items-center gap-2 border border-white/20 px-4 py-2 text-sm text-lightGrey transition hover:border-white hover:text-white md:flex'
          >
            <FiDownload size={13} />
            Resume
          </a>
            ...
            <ul className='container flex flex-col gap-5 py-6'>
              ...
              <li>
                <a
                  href='/favourite-jome_resume.pdf'
                  download
                  className='flex items-center gap-2 text-lightGrey transition hover:text-white'
                >
                  <FiDownload size={13} />
                  Resume
                </a>
      ...
      <main>
        ...
        >
          <div className='fadeIn'>
            ...
            <h1 className='mb-5 text-4xl font-bold leading-tight md:text-6xl'>
              Hi, I&apos;m{" "}
              <span className='text-white'>Favourite Jome</span>
            </h1>
        ...
        <section id='about' className='border-t border-white/10 py-20'>
          <div className='container'>
            ...
            <p className='mb-12 text-lightGrey'>A glimpse into my journey and passions.</p>
            ...
            <div className='flex flex-col gap-10 md:flex-row md:items-start md:gap-14'>
              ...
              <div className='flex flex-col justify-center gap-5'>
                <p className='leading-relaxed text-white/90'>
                  I&apos;m Favourite Jome, a Software Engineer focused on building
                  reliable systems, great developer tooling, and seamless user
                  experiences.
                </p>
                <p className='leading-relaxed text-lightGrey'>
                  My journey spans frontend development, customer engineering, and
                  technical writing — giving me a well-rounded perspective on how
                  software is built, used, and explained.
                </p>
                <p className='leading-relaxed text-lightGrey'>
                  Currently at <span className='text-white'>Bug0</span>, working on
                  AI-native browser testing infrastructure. I care deeply about code
                  quality, performance, and making software that actually works for
                  the people using it.
                </p>
                <p className='leading-relaxed text-lightGrey'>
                  Outside of engineering, I&apos;ve spent years writing technical
                  content on Hashnode and hosting{" "}
                  <span className='text-white'>The Learn With Me Series</span> — a
                  show about learning openly and sharing the process.
                </p>
          ...
          <div className='container max-w-3xl'>
            ...
            <div className='space-y-0'>
              {experiences.map((exp, ind) => (
                <div key={ind} className='group flex gap-5'>
                  ...
                  <div className='pb-10'>
                    <div className='mb-1 flex flex-wrap items-baseline gap-2'>
                      ...
                      <span className='text-sm text-lightGrey'>· {exp.role}</span>
                    </div>
        ...
        <section id='projects' className='border-t border-white/10 py-20'>
          <div className='container'>
            ...
            <div className='mt-5 grid gap-5 md:grid-cols-2 lg:grid-cols-3'>
              {otherProjects.filter(p => p.screenshot).map((project, ind) => (
                <div
                  key={ind}
                  className='group flex flex-col overflow-hidden rounded-lg border border-white/10 bg-darkCard transition hover:border-white/25'
                >
        ...
        >
          <div className='container'>
            ...
            <div className='grid gap-4 sm:grid-cols-2 lg:grid-cols-3'>
              {[
                {
                  title: 'The Hidden Power of Building Communities and Impact in Tech',
                  guest: 'Ibi',
                  duration: '49:42',
                  season: 'S2',
                  href: 'https://www.youtube.com/@favouritejome',
        ...
        {/* Writing */}
        <section id='writing' className='border-t border-white/10 py-20'>
          <div className='container'>
            <div className='mb-10 flex items-end justify-between'>
              <h2 className='text-xs uppercase tracking-widest text-lightGrey'>
                Writing
            ...
            {isLoading ? (
              <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-3'>
                {Array(6)
                  .fill(0)
                  .map((_, ind) => (
                    <div key={ind} className='border border-white/10 p-6'>
